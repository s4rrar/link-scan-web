      ...
      >
        <div
          className={
            scrolled
              ? glass.navbar
              : "mx-auto flex w-full items-center justify-between transition-all duration-300 max-w-6xl bg-transparent border border-transparent py-0"
          }
          dir={dir}
        >
